...
--
-- Host: localhost
-- Generation Time: Aug 17, 2022 at 01:43 PM
...
--
CREATE DATABASE IF NOT EXISTS `deepfake_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
--
-- Table structure for table `remote_user_deepfake_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_deepfake_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `url` varchar(30000) NOT NULL,
  `ipaddress` varchar(3000) NOT NULL,
  `videoname` varchar(3000) NOT NULL,
  `original_width` varchar(3000) NOT NULL,
  `original_height` varchar(3000) NOT NULL,
...
--
-- Dumping data for table `remote_user_deepfake_detection_type`
--

INSERT INTO `remote_user_deepfake_detection_type` (`id`, `url`, `ipaddress`, `videoname`, `original_width`, `original_height`, `country`, `locale`, `latitude`, `longitude`, `Prediction`) VALUES
(1, 'http://www.avevaconstruction.com/blesstool/image.htm\r\n', '175.180.184.106', 'lxnqzocgaq.mp4', '223', '217', 'Taiwan', 'Taipei', '25.0392', '121.525', 'FAKE'),
(2, 'https://www.velocidrone.com/\r\n', '213.215.43.23', 'ddvgrczjno.mp4', '155', '155', 'France', 'NA', '48.86', '2.35', 'REAL'),
(3, 'http://www.tutorialspoint.com/dbms/\r\n', '219.148.38.70', 'sjgbiywngj.mp4', '185', '186', 'China', 'Hebei', '39.8897', '115.275', 'FAKE'),
(4, 'http://support-appleld.com.secureupdate.duilawyeryork.com/ap/4a48dae8675698c\r\n', '198.20.69.74', 'ypewpvpfmk.mp4', '186', '186', 'United States', 'Illinois', '41.8825', '-87.6441', 'REAL'),
(5, 'http://creative-punch.net/2014/10/intro-html5-speech-synthesis-api/\r\n', '202.85.214.186', 'nuzbbjlaed.mp4', '154', '155', 'China', 'NA', '35', '105', 'FAKE');
...
(30, 'Naive Bayes', '56.91837625491052'),
(31, 'SVM', '56.852902662592754'),
(32, 'Logistic Regression', '59.88651243998254'),
(33, 'Decision Tree Classifier', '58.22784810126582'),
(34, 'GradientBoostingClassifier', '64.2732431252728');
